...
public class FileUpload {
    public BoardVO uploadPhoto(HttpServletRequest request){
        ...
        int sizeLimit = 15 * 1024 * 1024; //파일크키 (15MB)
        ...
        try {
            ...
            one = new BoardVO();
            String seq = multipartRequest.getContentType("seq");
            ...
            //one.setCnt(multipartRequest.getParameter("cnt"));

            if(seq!=null && seq.equals("")){ //eidt인 경우 기존 파일이름과 비료해야 함
