...
public class BoardDAO {
	...
	private final String BOARD_INSERT = "insert into BOARD2 (category, title, writer, content, photo) values (?,?,?,?,?)";
	private final String BOARD_UPDATE = "update BOARD2 set category=?, title=?, writer=?, content=?, photo=? where seq=?";
